...
#else
.equ	NULL, 0
//.equ	NODE_STRUCT_SIZE, __fill in__
//.equ	NODE_ID_OFFSET, __fill in__
//.equ	NODE_HEIGHT_OFFSET, __fill in with relative offset__
//.equ	NODE_XCOORD_OFFSET, __fill in with relative offset__
//.equ	NODE_YCOORD_OFFSET, __fill in with relative offset__
//.equ	NODE_NEXT_OFFSET, __fill in with relative offset__
#endif
#endif
